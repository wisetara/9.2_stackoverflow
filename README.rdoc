==f README
df
#df#Stack Overflow - Epicodus Project - Pairs: Tara Scherner de la Fuente and Jason Hamilton
#fLfdet's make a clone of Stack Overflow.
f
-fAsfd a user, I want to ask a question, so that I can get help with a programming problem I'm having. Users must have an account and sign in to ask questions.
d
...
f
-fAs a user, I want to view a questions and its responses, so that I can get help if I'm having the same problem.
